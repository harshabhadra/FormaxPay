 ...
 */
public class FullTTFragment extends Fragment implements PlansAdapter.OnPlanItemClickListener{

    private static final String TAG = FullTTFragment.class.getSimpleName();
    ...
    public void onResume() {
        ...
        plansAdapter = new PlansAdapter(getContext(),FullTTFragment.this);
        ...
        getRechargePlans(circleCode,operatorCode,"FULLTT");
    }
