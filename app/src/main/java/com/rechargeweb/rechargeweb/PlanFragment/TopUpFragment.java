 ...
 */
public class TopUpFragment extends Fragment implements PlansAdapter.OnPlanItemClickListener{
    ...
    public interface OnTopupItemClickListener{
        void onTopUpItemClikc(Plans plans);
    }
    ...
    public void onResume() {
        ...
        plansAdapter = new PlansAdapter(getContext(),TopUpFragment.this);
        ...
        getRechargePlans(circleCode,operatorCode,"TOPUP");
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        topupItemClickListener = (OnTopupItemClickListener)context;
    }
    ...
    public void onPlanItemClick(int position) {
        ...
        topupItemClickListener.onTopUpItemClikc(plans);
    }
}
