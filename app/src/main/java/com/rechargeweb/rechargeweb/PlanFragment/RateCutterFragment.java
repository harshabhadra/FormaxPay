 ...
 */
public class RateCutterFragment extends Fragment implements PlansAdapter.OnPlanItemClickListener {

    private static final String TAG = RateCutterFragment.class.getSimpleName();
    ...
    private OnRateCutterItemClickListener rateCutterItemClickListener;

    public RateCutterFragment() {
        // Required empty public constructor
    }

    public interface OnRateCutterItemClickListener{
        void onRateCutterItemclick(Plans plans);
    }
    ...
    public void onResume() {
        ...
        plansAdapter = new PlansAdapter(getContext(),RateCutterFragment.this);
        ...
        getRechargePlans(circleCode,operatorCode,"RATE CUTTER");
    }
    ...
    private void getRechargePlans(String circleId, String operator,String type) {
        ...
        planViewModel.getMobileRechargePlanList(circleId,operator,"COMBO").observe(getViewLifecycleOwner(), new Observer<List<Plans>>() {
            @Override
    ...
    public void onAttach(@NonNull Context context) {
        ...
        rateCutterItemClickListener = (OnRateCutterItemClickListener)context;
    }
    ...
    public void onPlanItemClick(int position) {
        ...
        rateCutterItemClickListener.onRateCutterItemclick(plans);
    }
}
