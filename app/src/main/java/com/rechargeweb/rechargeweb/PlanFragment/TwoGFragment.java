 ...
 */
public class TwoGFragment extends Fragment implements PlansAdapter.OnPlanItemClickListener{
    ...
    private OnTwoGFragmentClickListener twoGFragmentClickListener;

    public TwoGFragment() {
        // Required empty public constructor
    }

    public interface OnTwoGFragmentClickListener{

        void onTwoGItemClick(Plans plans);
    }
    ...
    public void onResume() {
        ...
        plansAdapter = new PlansAdapter(getContext(),TwoGFragment.this);
        ...
        getRechargePlans(circleCode,operatorCode,"2G");
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        twoGFragmentClickListener = (OnTwoGFragmentClickListener)context;
    }
    ...
    public void onPlanItemClick(int position) {
        ...
        twoGFragmentClickListener.onTwoGItemClick(plans);
    }
}
