 ...
 */
public class RoamingFragment extends Fragment implements PlansAdapter.OnPlanItemClickListener {

    private static final String TAG = RoamingFragment.class.getSimpleName();
    ...
    private OnRoamingItemClikcListener roamingItemClikcListener;

    public RoamingFragment() {
        // Required empty public constructor
    }

    public interface OnRoamingItemClikcListener{
        void onRoamingItemclick(Plans plans);
    }
    ...
    public void onResume() {
        ...
        plansAdapter = new PlansAdapter(getContext(),RoamingFragment.this);
        ...
        getRechargePlans(circleCode,operatorCode,"Roaming");
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        roamingItemClikcListener = (OnRoamingItemClikcListener)context;
    }
    ...
    public void onPlanItemClick(int position) {
        ...
        roamingItemClikcListener.onRoamingItemclick(plans);
    }
}
